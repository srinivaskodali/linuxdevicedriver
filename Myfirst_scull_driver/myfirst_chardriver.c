 ...
 * This file is a char driver which registers(static) and frees the device number.
 */
...
static int __init register_driver(void) {
	 ...
	 */
	if (!register_chrdev_region(dev_num, 50, "srini_snull"))
