 ...
 * This file is example for passing parameters to a module
 * Usage: sudo insmod Hello_world_param.ko name=srini nAge=30
 */
...
static int __init welcome(void) {
	...
	printk(KERN_ALERT "%s just loaded the module an his age is %d\n", name, nAge);
